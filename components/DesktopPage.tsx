...
export default function DesktopPage() {
  ...
  return (
    <div className="min-h-screen bg-ms-nocturne">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 px-4 bg-gradient-to-b from-ms-nocturne to-[#0A0F1A] flex flex-col items-center justify-center">
      ...
      <section className="pt-8 pb-16 px-4 bg-[#0A0F1A]">
      ...
      {/* Reviews */}
      <section className="pb-20 px-4 bg-[#0A0F1A]">
