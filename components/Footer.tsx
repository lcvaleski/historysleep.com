...
export default function Footer() {
  return (
    <footer className="py-20 px-4 bg-gradient-to-b from-[#0A0F1A] to-ms-nocturne flex flex-col items-center">
      <div className="flex items-center gap-2 mb-4">
        <Image src="/newlogo.png" alt="Bore" width={20} height={20} className="object-contain" />
